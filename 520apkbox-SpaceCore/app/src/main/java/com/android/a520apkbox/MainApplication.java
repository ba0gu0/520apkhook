...
public class MainApplication extends Application {
    ...
    protected void attachBaseContext(Context base) {
        ...
        try {
            ...
            DexZipFileName = Objects.requireNonNull(appInfo.metaData.get("DexZipFileName")).toString();
            DexZipFilePass = Objects.requireNonNull(appInfo.metaData.get("DexZipFilePass")).toString();
            RealApplicationName = Objects.requireNonNull(appInfo.metaData.get("RealApplicationName")).toString();
            RealActivityName = Objects.requireNonNull(appInfo.metaData.get("RealActivityName")).toString();
            RealServiceName = Objects.requireNonNull(appInfo.metaData.get("RealServiceName")).toString();
        ...
        try {
            // 初始化 SpaceCore MainApplication
            FCore.get().init(this);
            FCore.get().setAllowSystemInteraction(true);
            FCore.get().setEnableLauncherView(false);
